...
import styles from "../(tabs)/Screen3Styles";
...
export default function OnboardingScreen3() {
  ...
  const handleNext = () => {
    ...
    console.log("Нажат 4 онборндинг");
  };
      ...
      <View style={styles.container}>
        ...
        <View style={[styles.textContainer]}>
          <Text style={[styles.text, { fontSize: 20, fontWeight: "600" }]}>
            Внедрение пищевых привычек - это только начало.
          </Text>
          <Text style={[styles.text, { fontSize: 20, fontWeight: "600" }]}>
            <Text
              style={[
            ...
            поможет вам составить здоровую продуктовую корзину!
          </Text>
        </View>
        <Image
          source={require("../../assets/images/Logo.png")}
        ...
        <View style={styles.promo2}>
          <EqualIcon
            width={20}
            height={20}
            style={[styles.sign, { marginBottom: 27 }]}
          />
          <ShoppingIcon
            style={[styles.image, { marginBottom: 8, marginRight: 10 }]}
          />
